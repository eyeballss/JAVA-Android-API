...
public class MyDataPasserSenderSampleActivity extends AppCompatActivity {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(data!=null){
                    ...
                    startActivity(new Intent(MyDataPasserSenderSampleActivity.this, MyDataPasserReceiverSampleActivity.class));
                }
            }
        });
